    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_country', models.CharField(max_length=15, null=True, validators=[django.core.validators.RegexValidator(regex='^(\\d{10}|\\d{15})$'), django.core.validators.MinLengthValidator(limit_value=10, message='Phone number must be at least 10 digits.')])),
