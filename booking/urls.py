...
from .views import RoomDetailView, search_room, reservate_now, CreateGuest, UpdateGuest, ConfirmReservation, confirm_reservation_done
...
urlpatterns = [
    ...
    path('confirm_reservation/<uuid:uuid>/', ConfirmReservation.as_view(), name='confirm_reservation'),      # The uuid is the cart indentifier.
    path('confirm_reservation_done/<uuid:uuid>/', confirm_reservation_done, name='confirm_reservation_done'),# The uuid is the cart indentifier.
]